 ...
 *
 */
public class L2_LR_PreCalSSH extends AbstractFeatureFactory {
    ...
    public Feature createFeature(String fileName, String regex, String model) {
        ...
        toCreate.addProperty(IProperty.forType(PropertyType.STRING, GRANULE_TYPE, FULL_SWATH_HALF_ORBIT));
