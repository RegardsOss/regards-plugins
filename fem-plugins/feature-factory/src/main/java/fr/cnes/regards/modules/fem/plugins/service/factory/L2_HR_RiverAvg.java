 ...
 *
 */
public class L2_HR_RiverAvg extends AbstractFeatureFactory {
    ...
    public Feature createFeature(String fileName, String regex, String model) {
        ...
        toCreate.addProperty(IProperty.forType(PropertyType.STRING, GRANULE_TYPE, BASSIN));
        ...
        toCreate.addProperty(IProperty.forType(PropertyType.STRING, BASSIN_ID, matcher.group(3)));
