 ...
 * Abstract so subclasses can change the way content type is determined
 *
 * @author Vincent Carassus
 **/
@Component
public abstract class AbstractWorkerManagerSender extends AbstractRabbitMQSender {
     ...
     */
    protected abstract String getContentType(NotificationRequest notificationRequest);
}
