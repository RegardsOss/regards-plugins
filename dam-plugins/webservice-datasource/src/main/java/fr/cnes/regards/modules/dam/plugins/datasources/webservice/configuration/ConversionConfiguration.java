...
public class ConversionConfiguration {
     ...
     */
    @PluginParameter(name = "attributeToJSonField",
                     label = "Attribute path to JSon field",
                     keylabel = "attributePath",
     ...
     */
    @PluginParameter(name = "thumbnailURLPath",
     ...
     */
    @PluginParameter(name = "rawDataURLPath",
                     label = "Raw data URL path",
                     optional = true,
     ...
     */
    @PluginParameter(name = "quicklookURLPath",
                     label = "Quicklook URL path",
                     optional = true,
     ...
     */
    @PluginParameter(name = "totalResultsField",
     ...
     */
    @PluginParameter(name = "pageSizeField",
                     label = "Total results field",
