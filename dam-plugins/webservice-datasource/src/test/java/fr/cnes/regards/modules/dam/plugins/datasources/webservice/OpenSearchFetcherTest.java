    ...
    public void testBuildURL() {
        ...
        Assert.assertEquals("http://server1.com:3615/myURL?pageNumber=75&pageSize=35",
                            new OpenSearchFetcher(new WebserviceConfiguration("http://server1.com:3615/myURL",
                                    testDescriptor, "pageNumber", "pageSize", "lastUpdate", 10, 35, null), null, null)
                                            .getFetchURL(PageRequest.of(65, 55), null));// init page = 10, no update date by parameters, first query parameter (no query separator)
        ...
        Assert.assertEquals("https://server2.fr:3616/somewhere/here?index=1&count=20",
                            new OpenSearchFetcher(new WebserviceConfiguration("https://server2.fr:3616/somewhere/here?",
                                    testDescriptor, "index", "count", null, 1, null, null), null, null)
                                            .getFetchURL(PageRequest.of(0, 20), OffsetDateTime.now()));

        // init page = 0, config size = 50, update date OK, already some query (but not & parameter)
        Assert.assertEquals("https://server2.fr:3616/somewhere/here?a=abc&b=bcd&index=0&count=50&update=2019-02-18T15:30:44.372Z",
                            new OpenSearchFetcher(
                                    new WebserviceConfiguration("https://server2.fr:3616/somewhere/here?a=abc&b=bcd",
                                            testDescriptor, "index", "count", "update", 0, 50, null),
                                    null, null).getFetchURL(PageRequest.of(0, 20),
        ...
        Assert.assertEquals("http://server1.fr/here?a=abc&page=9&size=40&from=2019-02-18T15:30:44.372Z",
                            new OpenSearchFetcher(new WebserviceConfiguration("http://server1.fr/here?a=abc&",
                                    testDescriptor, "page", "size", "from", 1, null, null), null, null)
                                            .getFetchURL(PageRequest.of(8, 40),
                                                         OffsetDateTime.parse("2019-02-18T15:30:44.372Z")));
        ...
        Assert.assertEquals("https://server2.fr:3616/somewhere/here?a=abc&b=bcd&index=0&count=50&update=2019-02-18T15:30:44.372Z&param1=2&param2=true&param3=any",
                            new OpenSearchFetcher(
                                    new WebserviceConfiguration("https://server2.fr:3616/somewhere/here?a=abc&b=bcd",
                                            testDescriptor, "index", "count", "update", 0, 50, params),
                                    null, null).getFetchURL(PageRequest.of(0, 20),
                                                            OffsetDateTime.parse("2019-02-18T15:30:44.372Z")));
    }
