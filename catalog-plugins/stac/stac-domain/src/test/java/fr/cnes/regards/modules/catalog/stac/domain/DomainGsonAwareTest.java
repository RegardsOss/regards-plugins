...
import fr.cnes.regards.modules.catalog.stac.domain.api.gson.*;
...
/**
 * A GsonAwareTest with additional adapters for domain objects (Bbox...)
 *
 * @author Julien Canches
 */
public interface DomainGsonAwareTest extends GsonAwareTest {
    ...
    default GsonBuilder updateGsonBuilder(GsonBuilder builder) {
        ...
        builder.registerTypeAdapterFactory(new ItemCollectionResponseAdapterFactory());
        return builder;
    }
