...
public class DynCollValTest {
    ...
    StacProperty prop1 = new StacProperty(null, "prop1", "", false, 1, "0;10;100", StacPropertyType.NUMBER, null);
    StacProperty prop2 = new StacProperty(null, "prop2", "", false, 2, "DAY", StacPropertyType.DATETIME, null);
    StacProperty prop3 = new StacProperty(null, "prop3", "", false, 3, "PREFIX(2,9)", StacPropertyType.STRING, null);
    ...
    public void firstMissingValue() {
        assertThat(new DynCollVal(def, List.empty()).firstMissingValue())
                .contains(numberRangeLevelDef);
        ...
        assertThat(new DynCollVal(def,List.of(
                    numberRangeLevelDef.parseValues("20;30"),
                    datePartsLevelDef.parseValues("1999-01-01"),
                    stringPrefixLevelDef.parseValues("00")
            )).firstMissingValue())
                .isEmpty();
    }
    ...
    public void firstPartiallyValued() {
        assertThat(new DynCollVal(def, List.empty()).firstPartiallyValued())
                .isEmpty();

        assertThat(new DynCollVal(def,List.of(
                numberRangeLevelDef.parseValues("20;30")
        )).firstPartiallyValued())
                .isEmpty();
        ...
        assertThat(new DynCollVal(def,List.of(
                ...
                .contains(datePartsLevelDef.parseValues("1999-01"));
