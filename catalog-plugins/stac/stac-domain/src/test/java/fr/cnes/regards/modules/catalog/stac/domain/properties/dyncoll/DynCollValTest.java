...
public class DynCollValTest {
    ...
    StacProperty prop1 = new StacProperty(null,
                                          null,
                                          "prop1",
                                          "",
                                          false,
    ...
    StacProperty prop2 = new StacProperty(null,
                                          null,
                                          "prop2",
                                          "",
                                          false,
    ...
    StacProperty prop3 = new StacProperty(null,
                                          null,
                                          "prop3",
                                          "",
                                          false,
    ...
    public void firstMissingValue() {
        ...
        assertThat(new DynCollVal(def, List.of(numberRangeLevelDef.parseValues("20;30"))).firstMissingValue()).contains(
            datePartsLevelDef);

        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-01"))).firstMissingValue()).contains(
            stringPrefixLevelDef);

        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-01-01"))).firstMissingValue()).contains(
            stringPrefixLevelDef);
    ...
    public void firstPartiallyValued() {
        ...
        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"))).firstPartiallyValued()).isEmpty();

        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-01"))).firstPartiallyValued()).contains(
            datePartsLevelDef.parseValues("1999-01"));

        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-01-01"))).firstPartiallyValued()).isEmpty();

        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-01-01"),
                                          stringPrefixLevelDef.parseValues("0"))).firstPartiallyValued()).contains(
    ...
    public void isFullyValued() {
        ...
        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999"))).isFullyValued()).isFalse();

        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-01"))).isFullyValued()).isFalse();

        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-01-01"))).isFullyValued()).isFalse();
    ...
    public void getLowestLevelLabel() {
        ...
        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-10"))).getLowestLevelLabel()).isEqualTo(
            "prop2=1999-10");
    ...
    public void parentValue() {
        ...
        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999"))).parentValue()).contains(new DynCollVal(
            def,
            List.of(numberRangeLevelDef.parseValues("20;30"))));

        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-10"))).parentValue()).contains(new DynCollVal(
            def,
        ...
        assertThat(new DynCollVal(def,
                                  List.of(numberRangeLevelDef.parseValues("20;30"),
                                          datePartsLevelDef.parseValues("1999-01-01"),
                                          stringPrefixLevelDef.parseValues("0"))).parentValue()).contains(new DynCollVal(
            def,
