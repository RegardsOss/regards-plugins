 ...
 *
 * @see <a href="https://github.com/radiantearth/stac-spec/blob/v1.0.0/collection-spec/collection-spec.md#extent-object">description</a>
 */
@Value
@With
public class Extent {
    ...
    public static Extent maximalExtent() {
        return new Extent(new Spatial(List.of(new BBox(-180, -90, 180, 90))),
                          new Temporal(List.of(Tuple.of(lowestBound(), upperBound()))));
    }
}
