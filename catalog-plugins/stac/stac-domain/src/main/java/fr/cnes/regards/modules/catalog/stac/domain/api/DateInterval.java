...
public class DateInterval {
    ...
    public String repr() {
        String repr;
        if (isSingleDate()) {
            repr = StacConstants.ISO_DATE_TIME_UTC.format(from);
        } else {
            repr = (MIN.equals(from) ? OPEN_END : StacConstants.ISO_DATE_TIME_UTC.format(from)) + SEPARATOR + (MAX.equals(to) ?
                OPEN_END :
                StacConstants.ISO_DATE_TIME_UTC.format(to));
        }
        return repr;
    }
