...
public class DatetimeQueryCriterionBuilderTest implements RegardsPropertyAccessorAwareTest {
    ...
    public void testBuildCriterionAll() {
        ...
        assertThat(((DateMatchCriterion) ((NotCriterion) andCrits.get(1)).getCriterion()).getName()).isEqualTo(
            "feature.properties.regardsAttr");
        assertThat(((DateMatchCriterion) ((NotCriterion) andCrits.get(1)).getCriterion()).getValue()).isEqualTo(now.minusDays(
            1));
        ...
        assertThat(List.ofAll(((DateRangeCriterion) andCrits.get(2)).getValueComparisons())
                       .get(0)
                       .getValue()).isEqualTo(now.plusMinutes(2));
        assertThat(List.ofAll(((DateRangeCriterion) andCrits.get(2)).getValueComparisons())
                       .get(0)
                       .getOperator()).isEqualTo(LESS);
        ...
        assertThat(List.ofAll(((DateRangeCriterion) andCrits.get(3)).getValueComparisons())
                       .get(0)
                       .getValue()).isEqualTo(now);
        assertThat(List.ofAll(((DateRangeCriterion) andCrits.get(3)).getValueComparisons())
                       .get(0)
                       .getOperator()).isEqualTo(LESS_OR_EQUAL);
        ...
        assertThat(List.ofAll(((DateRangeCriterion) andCrits.get(4)).getValueComparisons())
                       .get(0)
                       .getValue()).isEqualTo(now.minusMinutes(2));
        assertThat(List.ofAll(((DateRangeCriterion) andCrits.get(4)).getValueComparisons())
                       .get(0)
                       .getOperator()).isEqualTo(GREATER);
        ...
        assertThat(List.ofAll(((DateRangeCriterion) andCrits.get(5)).getValueComparisons())
                       .get(0)
                       .getValue()).isEqualTo(now);
        assertThat(List.ofAll(((DateRangeCriterion) andCrits.get(5)).getValueComparisons())
                       .get(0)
                       .getOperator()).isEqualTo(GREATER_OR_EQUAL);
