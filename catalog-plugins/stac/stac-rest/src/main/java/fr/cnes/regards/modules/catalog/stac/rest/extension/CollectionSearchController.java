 ...
 */
package fr.cnes.regards.modules.catalog.stac.rest.extension;
 ...
 * starting from an item search.
 * It is the same workflow as the item search but the results are different :
 * TODO
 *
 * @author Marc SORDI
 *
