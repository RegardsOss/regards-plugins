...
public interface StacApiConstants {
    ...
    String STAC_DOWNLOAD_BY_COLLECTION_AS_ZIP_SUFFIX = STAC_COLLECTION_PATH_SUFFIX + STAC_DOWNLOAD_AS_ZIP_SUFFIX;

    String STAC_DOWNLOAD_BY_COLLECTION_SCRIPT_SUFFIX = STAC_COLLECTION_PATH_SUFFIX + STAC_DOWNLOAD_SCRIPT_SUFFIX;

    String STAC_DOWNLOAD_SAMPLE_BY_COLLECTION_AS_ZIP_SUFFIX = STAC_COLLECTION_PATH_SUFFIX
                                                              + STAC_DOWNLOAD_SAMPLE_AS_ZIP_SUFFIX
                                                              + STAC_DOWNLOAD_AS_ZIP_SUFFIX;

    String STAC_DOWNLOAD_BY_COLLECTION_AS_ZIPSTREAM_SUFFIX = STAC_COLLECTION_PATH_SUFFIX
                                                             + STAC_DOWNLOAD_AS_ZIPSTREAM_SUFFIX;

    String STAC_DOWNLOAD_SAMPLE_BY_COLLECTION_AS_ZIPSTREAM_SUFFIX = STAC_COLLECTION_PATH_SUFFIX
                                                                    + STAC_DOWNLOAD_SAMPLE_AS_ZIP_SUFFIX
                                                                    + STAC_DOWNLOAD_AS_ZIPSTREAM_SUFFIX;
