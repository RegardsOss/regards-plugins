...
public interface StorageCommand {
    ...
    interface Write extends StorageCommand {
        ...
        class Impl extends Base implements Write {
            ...
            @Override public StorageEntry getEntry() { return entry; }
        }
    }
    ...
    abstract class Base implements StorageCommand {
        ...
        @Override public String getEntryKey() { return entryKey; }
        @Override public StorageCommandID getCmdId() { return cmdId; }
        @Override public StorageConfig getConfig() { return config; }
    }
