 ...
 */
public class SmallFilesUtilsTest {
     ...
     * Method {@link SmallFilesUtils#restore(S3HighLevelReactiveClient, StorageConfigDto, String, String, Integer)}
    ...
    public void test_restore_FILE_AVAILABLE_after_AVAILABLE() {
        ...
        // When
        RestoreResponse restoreResponse = SmallFilesUtils.restore(s3ClientMock, null, "", "", 24);
    ...
    private void test_restore(RestoreStatus restoreStatus,
        ...
        // When
        RestoreResponse restoreResponse = SmallFilesUtils.restore(s3ClientMock, null, "", "", availabilityHours);
