...
public class LocalDataStorageTest {
    ...
    public void init()
        ...
        Mockito.when(mockLockService.waitForlock(Mockito.any(), Mockito.any(), Mockito.anyLong(), Mockito.anyLong()))
                .thenReturn(true);
        Field pluginLockService = plugin.getClass().getDeclaredField("lockService");
        pluginLockService.setAccessible(true);
        pluginLockService.set(plugin, mockLockService);
    ...
    public void deleteFromZipAndZip() throws IOException {
        ...
        fileRef.setId(1L);
        FileDeletionRequest deletionRequest = new FileDeletionRequest(fileRef, "groupId");
